...
<template>
  <!--
    ...
    renderer (project cards + preludes + corporations + CEOs since
    desktop-removal wave 4; scope gate = isPremiumFaceType) and the legacy
    renderer (standard projects until their own premium pass — the last
    type on legacy Card.vue in this tree).

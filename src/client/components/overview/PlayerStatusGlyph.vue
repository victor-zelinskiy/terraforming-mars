<template>
  <!--
    ...
    SVG-формы — простые геометрические примитивы (точка / галочка / пауза /
    шеврон / hollow-dot) на 14×14 view-box, stroke 1.8 px. Достаточно
  ...
  <svg v-else-if="glyph === 'chevron'"
       class="player-status-chip__glyph player-status-chip__glyph--chevron"
       viewBox="0 0 14 14"
       aria-hidden="true">
    <path d="M4.5 3 L9.5 7 L4.5 11"
          fill="none"
          stroke="currentColor"
          stroke-width="1.8"
          stroke-linecap="round"

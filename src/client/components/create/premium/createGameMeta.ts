...
export const BOT_SUPPORTED_MODULES_KEY = 'MarsBot supports five adapted maps (or a random one) with Corporate Era, Prelude, Venus Next, Colonies and Hydronetworks. Conflicting options are highlighted below.';

...
export const BOT_SUPPORTED_MODULES_KEY = 'MarsBot supports the Tharsis and Hellas maps with Corporate Era, Prelude, Venus Next, Colonies and Hydronetworks. Conflicting options are highlighted below.';

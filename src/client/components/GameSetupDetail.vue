        ...
        <div id="game-setup-detail" class="game-setup-detail-container">
          <ul>
            <li><div class="setup-item" v-i18n>Expansion:</div>
              ...
              <a v-if="gameOptions.expansions.deltaProject" :href="rulebookUrls.deltaProject" class="tooltip" data-tooltip="Hydronetwork rules" target="_blank"><div class="create-game-expansion-icon expansion-icon-deltaProject"></div></a>
            </li>

...
export enum MarsBotCorpId {
  ...
  C14_POINT_LUNA = 'C14',
  C15_ROBINSON_INDUSTRIES = 'C15',
  C16_VALLEY_TRUST = 'C16',
  C17_VITOR = 'C17',
  C18_ARCADIAN_COMMUNITIES = 'C18',
  C19_ASTRO_DRILL = 'C19',
  C20_FACTORUM = 'C20',
  ...
  C33_POSEIDON = 'C33',
  C34_STORMCRAFT = 'C34',
  C35_LAKEFRONT_RESORTS = 'C35',
  C36_PRISTAR = 'C36',
  C38_TERRALABS = 'C38',
  C39_UTOPIA_INVEST = 'C39',
  C40_ECOTEC = 'C40',
  C41_KUIPER_COOPERATIVE = 'C41',
  C42_NIRGAL_ENTERPRISES = 'C42',
  C43_PALLADIN_SHIPPING = 'C43',
  C44_SAGITTA_FRONTIER_SERVICES = 'C44',
  C45_SPIRE = 'C45',

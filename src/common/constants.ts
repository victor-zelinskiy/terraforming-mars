...
export const TEST_MODE_CORPORATION_CARDS_DEALT_PER_PLAYER = 8;
export const TEST_MODE_PROJECT_CARDS_DEALT_PER_PLAYER = 20;
export const TEST_MODE_INITIAL_DRAFT_PROJECT_CARDS_PER_ITERATION = 10;
export const TEST_MODE_STARTING_RESOURCE_COUNT = 500;
...
export const TEST_MODE_PRELUDE_CARDS_DEALT_PER_PLAYER = 10;

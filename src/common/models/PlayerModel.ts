...
export interface PlayerViewModel extends ViewModel {
  ...
  // Self-only, transient (cleared on the next input): what the ENACTED LAW paid
  // on this placement over and above the engine's own bonuses (Development Craze
  // repeats them, Forestry Support introduces a greenery adjacency). The premium

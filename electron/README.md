...
| `TM_ELECTRON_SOFTWARE` | — | `=1` forces the SOFTWARE rendering path (`--disable-gpu` + parallel raster threads) — the one-line rollback for the Steam Deck's Graphite/Vulkan GPU default; also a Windows diagnostic. |
